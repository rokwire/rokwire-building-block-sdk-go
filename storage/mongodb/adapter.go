...
func (a *Adapter) WithContext(ctx context.Context) common.Storage {
	return &Adapter{db: a.db, Context: ctx, cachedConfigs: a.cachedConfigs, configsLock: a.configsLock}
}
