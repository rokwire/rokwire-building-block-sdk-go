# Rokwire SDK for Go
rokwire-sdk-go is the official Rokwire SDK for Golang. This SDK enables easy communication with the Rokwire Building Blocks and provides commonly used utilities that 

## Installation
To install this package or upgrade to the latest version, use `go get`:

```
go get -u github.com/rokwire/rokwire-sdk-go
```
